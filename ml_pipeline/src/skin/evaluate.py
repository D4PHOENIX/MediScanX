...
def main():
    ...
    # IMPORTANT: Update this path to point to the actual .ckpt file generated by train.py!
    checkpoint_path = "models/mediscanx-skin-best-epoch=15-val_loss=0.547.ckpt" 
