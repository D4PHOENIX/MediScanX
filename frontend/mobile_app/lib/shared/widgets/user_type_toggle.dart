// lib/shared/widgets/user_type_toggle.dart

import 'package:flutter/cupertino.dart';
import 'package:flutter/material.dart';
import '../../../core/themes/app_colors.dart'; // Fixed paths to be relative/standard
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: AppColors.borderColor.withOpacity(0.2), // Light background for the track
