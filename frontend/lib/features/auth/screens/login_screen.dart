...
class _LoginScreenState extends ConsumerState<LoginScreen> {
  ...
  Future<void> _handleLogin() async {
    ...
    if (_usernameError == null && _passwordError == null) {
      ...
      try {
        // Suppress automatic navigation while we run our server-side validation checks
        ...
        if (success) {
          ...
          if (mounted) {
            setState(() {
              _loginError = authState.error?.toString() ?? 'Invalid login credentials.';
            });
          }
        }
      } catch (e) {
        if (mounted) {
          setState(() {
            _loginError = ErrorHelper.getHumanReadableError(e);
          });
        }
      } finally {
        if (mounted) {
                ...
                children: [
                  ...
                  Align(
                    ...
                    child: Padding(
                      ...
                      child: InkWell(
                        onTap: () => context.goNamed('password-reset'),
